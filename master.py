...
scaling{
    ...
    b_scaling = isotropic *anisotropic scale_only no 
        .type = choice(multi=False)
        .help = B-factor scaling for scaling triggered data vs reference data using scaleit. Use scale_only for only applying the main scale factor. The option 'no' has become obsolute and is replaced by data_scaling=no 
        .expert_level = 0
    high_resolution = None
        .type = float
