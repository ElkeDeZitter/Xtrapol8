...
class TabExtrapolation(ScrolledPanel):
    ...
    def createAndLayout(self):
        ...
        self.X8Modes = wx.RadioBox(
            self,
            1,
            "Xtrapol8 Modes",
            size=(800, -1),
            choices=["FoFo only ", "Fast and Furious ", "Calm and Curious "],
        )
        ...
        self.StepsTextCtrl = wx.TextCtrl(
            self,
            wx.ID_ANY,
            "5",
            style=wx.TE_PROCESS_ENTER,
        ...
        self.ListTextCtrl = wx.TextCtrl(
            self, wx.ID_ANY, "", style=wx.TE_PROCESS_ENTER, size=(120, height_TextCtrl)
        )
        ...
        self.ExtSF_box = wx.StaticBox(
            self, 1, "Extrapolated structure factor amplitudes", size=(800, 200)
        )
        ...
        peak_detection_threshold = wx.StaticText(
            self, wx.ID_ANY, "Peak_detection_threshold (sigma) :", size=(250, 20)
        )
        peak_detection_threshold.SetFont(defont)
        peak_integration_floor = wx.StaticText(
            self, wx.ID_ANY, "Peak_integration_floor (sigma) :", size=(250, 20)
        )
        ...
        self.peak_detection_thresholdTextCtrl = wx.TextCtrl(
            self,
            wx.ID_ANY,
            "4.0",
            style=wx.TE_PROCESS_ENTER,
        ...
        self.peak_integration_floorTextCtrl = wx.TextCtrl(
            self,
            wx.ID_ANY,
            "3.5",
            style=wx.TE_PROCESS_ENTER,
        ...
        self.RadiusTextCtrl = wx.TextCtrl(
            self,
            wx.ID_ANY,
            "1.5",
            style=wx.TE_PROCESS_ENTER,
        ...
        self.ZscoreTextCtrl = wx.TextCtrl(
            self,
            wx.ID_ANY,
            "2.0",
            style=wx.TE_PROCESS_ENTER,
        ...
        self.occ_est = wx.StaticText(
            self, wx.ID_ANY, "Occupancy estimation :", size=(180, 20)
        )
        self.occ_est.SetFont(defont)
        self.occ_list_all = [
            "difference_map_maximization",
            "difference_map_PearsonCC",
            "distance_analysis",
        ]
        self.occ_list_noref = [
            "difference_map_maximization",
        ...
        self.OccEstimation = wx.Choice(
            self, wx.ID_ANY, choices=self.occ_list_all, name="Occupancy estimation"
        )
        ...
        MES_fgs.AddMany(
            [
                ...
                self.peak_detection_thresholdTextCtrl,
                blank,
                peak_integration_floor,
                self.peak_integration_floorTextCtrl,
                radius,
                self.RadiusTextCtrl,
                blank1,
                zscore,
        ...
        self.negChoice = wx.Choice(
            self,
            wx.ID_ANY,
            choices=["truncate", "reject", "zero", "fref", "fcalc", "keep", "absolute"],
            size=(width_ChoiceCtrl, height_ChoiceCtrl),
        )
        self.negChoice.SetFont(defont)
        self.negChoice.SetSelection(0)
        self.missChoice = wx.Choice(
            self,
            wx.ID_ANY,
            choices=["fill", "no_fill"],
            size=(width_ChoiceCtrl, height_ChoiceCtrl),
        )
        ...
        ScalingTxt = wx.StaticText(
            self, wx.ID_ANY, "B-factor Scaling :", size=(200, 20)
        )
        self.ScalingChoice = wx.Choice(
            self,
            wx.ID_ANY,
            choices=["no", "isotropic", "anisotropic"],
            size=(width_ChoiceCtrl, height_ChoiceCtrl),
        )
        self.ScalingChoice.SetSelection(2)
        ScalingTxt.SetFont(defont)

        ScalingHighResTxt = wx.StaticText(
            self, wx.ID_ANY, label="Scaling high resolution :", size=(200, 20)
        )
        ScalingHighResTxt.SetFont(defont)
        self.ScalingHighRes = wx.TextCtrl(
            self,
            wx.ID_ANY,
            "",
            style=wx.TE_PROCESS_ENTER,
        ...
        ScalingLowResTxt = wx.StaticText(
            self, wx.ID_ANY, label="Scaling low resolution :", size=(200, 20)
        )
        ScalingLowResTxt.SetFont(defont)
        self.ScalingLowRes = wx.TextCtrl(
            self,
            wx.ID_ANY,
            "",
            style=wx.TE_PROCESS_ENTER,
